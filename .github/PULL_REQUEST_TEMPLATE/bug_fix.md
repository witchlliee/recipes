...
### aerynOS Bug Fix Pull Request

#### Summary

<!-- Replace this with a summary of bug fixes you are making -->

#### Checklist

- [ ] This bug fix links back to an existing issue (link: #[issue number])
...
<!-- Paste any terminal output, screenshots, or build logs that demonstrate success in fixing the bug/issue -->
